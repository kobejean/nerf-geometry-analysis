...
class CameraOnSphere(blender_nerf_operator.NeRFDataset_Operator):
    ...
    def execute(self, context):
        ...
        elif scene.camera_layout_mode == "golden_spiral":
            helper.create_golden_spiral_camera_points(scene)
        ...
        sphere_output_data['geometry_analysis_dimensions'] = {
            'size': [*scene.geometry_size],
            'radius': scene.geometry_radius,
        }
