...
@dataclass
class JeanModelConfig(ModelConfig):
    """Jean Model Config"""

    _target: Type = field(default_factory=lambda: JeanModel)
...
class JeanModel(Model):
    """Jean model

    Args:
        config: Jean configuration to instantiate model
    """

    config: JeanModelConfig
